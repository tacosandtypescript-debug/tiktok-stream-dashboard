...
interface Props {
  ...
  /** Si se está guardando el histórico de aportaciones de por vida. */
...
export function Tts({ initial, lifetimeEnabled, lifetimeBusy, onLifetimeChange }: Props) {
    ...
    <div className="grid-panel">
      ...
      <div className="grid-columns">
        ...
        <div className="stack">
          ...
          {/* Ajuste del historico de aportaciones. Vive aqui porque esta es la
              pagina de ajustes operativos y no merece una pestaña propia; el dato
              que guarda se ve en la pagina de Aportaciones. El estado y el guardado
              los lleva `App`: esta pagina solo pinta el interruptor. */}
          <Card title={t.aportaciones.lifetime}>
            ...
            <p className="hint">{t.aportaciones.toggleHint}</p>
          </Card>
        </div>
      </div>
